...
public class ParanoiaConstants {
	...
	public static final boolean CLEAR_LOGS_ON_STARTUP = true;
	...
	public static final boolean ALLOW_BLACKLIST_COMMAND = true; // blacklist users with GM !blacklist
	public static final boolean ALLOW_RELOADBLACKLIST_COMMAND = true; // reload blacklist with Dev !reloadblacklist
	public static final boolean CLEARLOG_CLEARS_BLACKLIST = true; // allow !clearlogs to clear blacklists.
	
	// Paranoia Blacklisting settings -- support for account logging with everything
	public static final boolean ENABLE_BLACKLISTING = true;
	...
	public static final boolean PARANOIA_CHAT_LOGGER = true;
	public static final boolean LOG_GENERAL_CHAT = true;
	public static final boolean LOG_PARTY_CHAT = true;
	public static final boolean LOG_BUDDY_CHAT = true;
	public static final boolean LOG_GUILD_CHAT = true;
	public static final boolean LOG_ALLIANCE_CHAT = true;
	...
	public static final boolean LOG_INVALID_COMMANDS = true;
	public static final boolean LOG_PLAYER_COMMANDS = true;
	public static final boolean LOG_DONOR_COMMANDS = true;
