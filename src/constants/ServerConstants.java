...
public class ServerConstants {
	...
	public static String ORPHEUS_VERSION = "24/12/16"; // date of version publishing
	public static final String SERVER_NAME = "AuroStory"; // Server's name
	public static final String TIP_NAME = "AuroTip"; // Tip Name for automsg
	public static String[] WORLD_NAMES = {"MapleStory", "Bera", "Broa", "Windia", "Khaini", "Bellocan", "Mardia", "Kradia", "Yellonde", "Demethos", "Galicia", "El Nido", "Zenith", "Arcenia", "Kastia", "Judis", "Plana", "Kalluna", "Stius", "Croa", "Medere"};
	...
	public static final boolean USE_EXTERNAL_COMMAND_LOADER = false; // if true, commands will be loaded externally. (Beginners should set to false)
	...
	// Rate Configuration
	public static final boolean BEGINNERS_USE_GMS_RATES = true; // if true, beginners will use GMS rates instead of server rates.
	...
	public static final boolean FREE_NX = false; // if true, @nx command is free.
	public static final int NX_COST = 10; // if false, @nx command costs this amount.
	...
	public static final boolean ENABLE_HARDCORE_MODE = false; // if true, players can enter hardcore mode for double exp and mesos.
	...
	public static final boolean DB_USE_COMPILED_VALUES = true; // if true, then the values below will be used.
	public static final String DB_URL = "jdbc:mysql://localhost:3306/MapleStoryv83?autoReconnect=true";
