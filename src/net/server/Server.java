...
public class Server implements Runnable {
	...
	public void run() {
		...
		if (!ServerConstants.DB_USE_COMPILED_VALUES) { 
			DatabaseConnection.update("jdbc:mysql://" + p.getProperty("mysql_host") + ":" + p.getProperty("mysql_port") + "/MapleStoryv83?autoReconnect=true", p.getProperty("mysql_user"), p.getProperty("mysql_pass"));
		}
